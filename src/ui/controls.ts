...
function buildHTML(p: MazeParams, activeCategory: CategoryScope): string {
  ...
  return `
    ...
    <div class="nav-links">
      <a href="./kinetic/" title="A maze on an object that turns — every way of turning it is a different maze, and every one is solvable">Kinetic maze &#8594;</a>
      <a href="./fold/" title="A maze on eight cubes taped into a ring — fold it and half the maze goes inside, and what is left is still a perfect maze">Folding maze &#8594;</a>
