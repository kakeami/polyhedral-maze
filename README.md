...
rhombicosidodecahedra, and the 8 sporadic Johnson solids J85–J92), and 4
toroidal (genus-1) polyhedra including the Császár polyhedron — 145 shapes
in total — and explore them in an interactive 3D viewer.

## Features

- **145 polyhedra** across eight categories:
  ...
  - **Toroidal (4)** — genus-1 polyhedra (mazes can loop around the hole): square torus, hexagonal torus, drilled truncated octahedron (a Stewart-toroid-style tunnel), and the Császár polyhedron (7 vertices, no diagonals — K₇ embedded on a torus)
...
|-----------|--------|---------|
| `shape` | one of the 145 shape IDs below | `icosahedron` |
...
| Toroidal | `square-torus`, `hexagonal-torus`, `drilled-truncated-octahedron`, `csaszar-polyhedron` |
