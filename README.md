...
- **144 polyhedra** across eight categories:
  ...
  - **Toroidal (3)** — genus-1 polyhedra (mazes can loop around the hole): square torus, hexagonal torus, drilled truncated octahedron (a Stewart-toroid-style tunnel). Their nets export as two pieces — outer shell + tunnel liner — since a one-piece genus-1 net is impractical to assemble
